...
function imgUpload(obj) {
	...
	var imgBox = '#' + obj.imgBox;//存储图片的div id
	var btn = '#' + obj.buttonId;//$("#btn")
	...
	$(btn).on('click', function() {
		...
		for(var i=0;i<imgFile.length;i++){//2
...
//图片展示
function addNewContent(obj) {//obj div的id
	$(imgBox).html("");
